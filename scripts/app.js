...
const app = Vue.createApp({
    ...
    data() {
        return {
            ...
            estadisticas: {
                ...
                Democrats: [],
                Independents: [],
                republicanVoteParty: 0,
                democratsVoteParty: 0,
                independentsVoteParty: 0,
                republicanVoteAverage: 0,
                democratsVoteAverage: 0,
                independentsVoteAverage: 0,
                congressmenWithVotes: 0,
                congressmenWigherWotes: [],
                congressmenFewerVotes: [],
                leastLoyalty: [],
                mostLoyalty: [],
            }
        }
    ...
    methods: {
        ...
        congresistasConVotosMayor() {
            ...
            let porcentajeFinal = this.estadisticas.congressmenWigherWotes[puntoDeCorte - 1]
